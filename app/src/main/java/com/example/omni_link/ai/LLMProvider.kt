...
interface LLMProvider {
        ...
        /**
         * Generate contextual suggestions with streaming output. Emits SuggestionStreamEvent
         * objects:
        ...
        fun generateSuggestionsStreaming(
                ...
                useCloudInference: Boolean = false,
                cactusToken: String? = null
        ): Flow<SuggestionStreamEvent>

        /**
         * Generate contextual options/actions for selected text from OCR. This is used for
         * Circle-to-Search style text selection feature.
         *
